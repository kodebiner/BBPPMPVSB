    ...
    <div id="offcanvas-overlay" uk-offcanvas="overlay: true">
        <div class="uk-offcanvas-bar" style="background-color: rgb(37, 150, 190)">
            ...
            <ul class="uk-iconnav uk-iconnav-vertical uk-nav-default" uk-nav>
                ...
                <li class="uk-nav-divider uk-margin-small <?= (($uri->getSegment(1) === 'dashboard')) && ($uri->getSegment(2) === 'maklumat') || (($uri->getSegment(1) === 'dashboard')) && ($uri->getSegment(2) === 'addmaklumat') || (($uri->getSegment(1) === 'dashboard')) && ($uri->getSegment(2) === 'editmaklumat') ? 'uk-active' : '' ?>"><a href="dashboard/maklumat"><span class="uk-margin-right" uk-icon="commenting"></span>Maklumat</a></li>
                <li class="uk-nav-divider uk-margin-small <?= (($uri->getSegment(1) === 'dashboard')) && ($uri->getSegment(2) === 'survei') || (($uri->getSegment(1) === 'dashboard')) && ($uri->getSegment(2) === 'addsurvei') || (($uri->getSegment(1) === 'dashboard')) && ($uri->getSegment(2) === 'editsurvei') ? 'uk-active' : '' ?>"><a href="dashboard/survei"><span class="uk-margin-right" uk-icon="list"></span>Survei</a></li>
