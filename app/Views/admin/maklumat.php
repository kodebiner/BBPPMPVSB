            ...
            <div class="uk-card-body">
                ...
                <div class="uk-margin">
                    <div class="uk-form-controls">
                        <textarea class="uk-textarea uk-box-shadow-small uk-border-rounded" id="file-picker" name="konten" placeholder="Masukkan Konten..." aria-label="Textarea"><?php if (!empty($maklumat)) { ?><?= $maklumat['text'] ?><?php } ?></textarea>
                    </div>
                </div>
                <!-- Input Content -->
            </div>
