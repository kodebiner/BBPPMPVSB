...
<?= $this->section('content') ?>
    ...
    <div class="uk-card uk-card-small uk-card-body uk-margin-xlarge-right uk-light" style="background-color:  rgba(60, 105, 151, .8);">
        <div class="uk-child-width-1-2" uk-grid>
            <div>
                <h3 class="uk-card-title">Tambah Seminar</h3>
            </div>
    ...
    <div class="uk-card uk-card-default uk-margin-xlarge-right">
        ...
        <form action="add/seminar" method="post">
            <div class="uk-card-body">

            <div class="uk-margin">
                <label class="uk-form-label uk-text-default uk-margin-small-left uk-text-bold" for="form-stacked-text">Status Seminar</label>
            ...
            <div class="uk-margin">
                <div class="uk-form-controls">
                    <textarea class="uk-textarea uk-box-shadow-small uk-border-rounded" id="ringkasan" rows="5" name="ringkasan" placeholder="Masukkan Ringkasan..." aria-label="Textarea" onchange="preview()"></textarea>
                </div>
            </div>
            ...
            <div class="uk-margin" id="image-container-create">
                <div id="image-container" class="uk-form-controls">
                    ...
                    <input id="foto" name="foto" hidden onchange="preview()" />
    ...
    <div class="uk-modal-full" id="preview" uk-modal>
        <div class="uk-modal-dialog" uk-height-viewport>
            <div class="uk-modal-header">
                <h2 class="uk-modal-title">Preview Tambah Seminar</h2>
                    ...
                    <div class="uk-container">
                        <div class="uk-container uk-container-xsmall">
                            <div class="tm-grid-expand uk-child-width-1-1" uk-grid>
                                <div>
                                    <h3 class="uk-margin uk-text-center" id="previewtitle"></h3>
                                </div>
                                <div class="uk-panel uk-text-lead uk-margin-large uk-text-center">
                                    <div><p id="previewintrotext" class="uk-text-justify"></p></div>
                                </div>
                                <div class="uk-margin">
                        ...
                        <div class="uk-margin">
                            <div class="uk-margin-small">
                                <img id="previewimage" src="" class="uk-width-1-1" />
                            </div>
                        </div>

                        <div class="uk-container uk-container-xsmall">
                            <div class="uk-panel uk-margin" id="previewfulltext"></div>
                        </div>
                    </div>
                </section>
            </div>
    ...
    <script>
        ...
        function preview(inst) {
            ...
            $('#previewimage').attr('src', 'images/'+photo);
