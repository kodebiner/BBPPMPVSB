        ...
        <form action="save/slideshow/<?=$news['id']?>" method="post">
                ...
                <div>
                    <div class="uk-card uk-card-default">
                        <div class="uk-card-media-top uk-text-center">
                            <div uk-lightbox>
                                <a class="uk-inline" id="fileimagecontainer" href="img/slideshow/<?=$news['file']?>" data-caption="<?=$news['file']?>">
                                    <img id="fileimage" class="uk-margin-top uk-margin-bottom" src="img/slideshow/<?=$news['file']?>" width="300" height="150" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="uk-margin" id="image-container-create">
                <div id="image-container" class="uk-form-controls">
                    ...
                    <input id="foto" name="foto" hidden value="<?=$news['file']?>"/>
