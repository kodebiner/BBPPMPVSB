...
<div class="uk-card uk-card-small uk-card-body uk-margin-large-right uk-light" style="background-color:  rgba(60, 105, 151, .8);;">
    <h3 class="uk-card-title">Tambah Pengguna</h3>
</div>
        ...
        <div class="uk-card-body">
            ...
            <div class="uk-margin">
                <div class="uk-form-controls">
                    <input class="uk-input uk-box-shadow-small uk-border-rounded" id="form-stacked-text" name="username" type="text" placeholder="Masukkan Nama...">
                </div>
            </div>
