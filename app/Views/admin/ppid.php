...
<?= $this->section('content') ?>
    ...
    <div class="uk-card uk-card-small uk-card-body uk-margin-xlarge-right uk-light" style="background-color: rgba(60, 105, 151, .8);">
        <div class="uk-child-width-1-2" uk-grid>
            <div>
                <h3 class="uk-card-title">PPID</h3>
            </div>
    ...
    <div class="uk-card uk-card-default uk-margin-xlarge-right">
        ...
        <form action="add/ppid" method="post">
            <div class="uk-card-body">
                <!-- Input Content -->
                <label class="uk-form-label uk-text-default uk-margin-small-left uk-text-bold" for="form-stacked-text">Konten</label>
                <div class="uk-margin">
                    <div class="uk-form-controls">
                        <textarea class="uk-textarea uk-box-shadow-small uk-border-rounded" id="file-picker" name="konten" placeholder="Masukkan Konten..." aria-label="Textarea" onchange="preview()"><?php if (!empty($ppids)) { ?><?= $ppids['content'] ?><?php } ?></textarea>
                    </div>
                </div>
                <!-- Input Content -->
            </div>
    ...
    <div class="uk-modal-full" id="preview" uk-modal>
        <div class="uk-modal-dialog" uk-height-viewport>
            <div class="uk-modal-header">
                <h2 class="uk-modal-title">Preview PPID</h2>
                <button class="uk-modal-close-default" type="button" uk-close></button>
            </div>

            <div class="uk-modal-body">
                <section class="uk-section-default uk-section">
                    <div class="uk-container uk-container-xlarge" id="previewcontent"><?php if (!empty($ppids)) { ?><?= $ppids['content'] ?><?php } ?></div>
                </section>
            </div>
        </div>
    </div>
