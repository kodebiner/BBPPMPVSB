                ...
                <table class="uk-table uk-table-small uk-table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="uk-text-center">Kelola Web Binar</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($berita as $news) { ?>
                            <tr id="rowberita<?=$news['id']?>">
                                ...
                                <td class="uk-child-width-auto uk-flex-center uk-flex-middle uk-grid-row-small uk-grid-column-small uk-text-center" uk-grid>
                                    <div>
                                        <a style="background-color: rgba(60, 105, 151, .8); color: white;" class="uk-icon-button" href="dashboard/editwebbinar/<?=$news['id']?>" uk-icon="icon: file-edit; ratio:1"></a>
                                    </div>
                                    <div>
