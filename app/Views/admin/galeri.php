...
<?= $this->section('content') ?>
    <div class="uk-child-width-expand@s uk-margin-large-right" uk-grid>
        <div class="uk-grid-item-match">
            <div>
                <h3 class="uk-margin">Kelola Galeri</h3>
            </div>
        </div>
        <div class="uk-text-right">
            <a class="uk-button uk-button-primary uk-border-rounded" href="#modal-add" uk-toggle><span uk-icon="icon: plus; ratio:0.8"></span>&nbsp;Foto</a>
        </div>
    </div>
