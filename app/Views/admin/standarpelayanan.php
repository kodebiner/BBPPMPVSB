...
<?= $this->section('content') ?>
    ...
    <div class="uk-card uk-card-small uk-card-body uk-margin-xlarge-right uk-light" style="background-color: rgba(60, 105, 151, .8);">
        <h3 class="uk-card-title">Standar Pelayanan</h3>
    </div>

    <div class="uk-card uk-card-default uk-margin-xlarge-right">
        <?= view('Views/Auth/_message_block') ?>
        <form action="add/standarpelayanan" method="post">
            <div class="uk-card-body">
                <!-- Upload File -->
                <h5 class="uk-margin-small-top">File Standar Pelayanan</h5>
                <div class="uk-child-width-1-1@m" uk-grid>
                    <div>
                        <div class="uk-card uk-card-default">
                            <div class="uk-card-body uk-text-center">
                                <?php if (!empty($sp)) { ?>
                                    <h5 id="uppdf"><a id="filepdf" href="standarpelayanan/<?=$sp['file']?>" target="_blank"><span uk-icon="file-text"></span><?=$sp['file']?></a></h5>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="uk-margin" id="file-container-createsp">
                    <div id="file-containersp" class="uk-form-controls">
                        <input id="file" name="file" hidden />
                        <div id="js-upload-filesp" class="js-upload-filesp uk-placeholder uk-text-center">
    ...
    <script>
        ...
        UIkit.upload('.js-upload-filesp', {
            ...
            complete: function () {
                ...
                var FileContainer = document.getElementById('file-container-createsp');
                ...
                link.setAttribute('href', 'standarpelayanan/' + pdfname);
                ...
                closeButton.setAttribute('onClick', 'removeFilesp()');
                ...
                document.getElementById('js-upload-filesp').setAttribute('hidden', '');
            },
        ...
        function removeFilesp() {
            $.ajax({
                type: 'post',
                url: 'upload/removepdfsp',
                data: {
                ...
                success: function() {
                    ...
                    document.getElementById('js-upload-filesp').removeAttribute('hidden', '');
                }
            });
        };
    </script>
